...
public class SetArmHighConeCommand extends CommandBase {
  ...
  public SetArmHighConeCommand(GrabbyLifterSubsystem grabbyLifterSubsystem, FirstExtenderSubsystem firstExtenderSubsystem, SecondExtenderSubsystem secondExtenderSubsystem) {
