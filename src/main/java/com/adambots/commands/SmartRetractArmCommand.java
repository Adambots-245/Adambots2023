...
public class SmartRetractArmCommand extends CommandBase {
  /** Creates a new LiftArmCommand. */
  FirstExtenderSubsystem firstExtenderSubsystem;
  SecondExtenderSubsystem secondExtenderSubsystem;

  public SmartRetractArmCommand(FirstExtenderSubsystem firstExtenderSubsystem, SecondExtenderSubsystem secondExtenderSubsystem) {
  ...
  @Override
  public void execute() {
    if (secondExtenderSubsystem.isMaxRetracted()) {
