...
public final class Constants {
    ...
    public static final class GrabbyConstants {
        ...
        public static final State autonHighConeState = new State(highConeLifterValue-5, highConeFirstExtenderValue, highConeSecondExtenderValue-9*armEncoderCPR);
        ...
        //general
        public static final double firstExtenderMaxExtend = 60 * armEncoderCPR; //60.25
